      ...
      <header className="w-full bg-[#FEFFFF]  flex justify-center ">
        <div className="container flex justify-between items-center p-2 border-b border-black/15">
          ...
          <nav className="w-104.5 text-[#627384] flex items-center justify-center gap-5 ">
            <a className="text-[12px]">Find Doctors</a>
            <a className="text-[12px]">Services</a>
            <a className="text-[12px]">Consult Online</a>
            <a className="text-[12px]">About</a>
            <a className="text-[12px]">Contact</a>
          </nav>
          <div className="flex gap-3">
          <button className="bg-[#0da2e7] text-white px-4 py-1.5 text-[9px] rounded-2xl ">
            Book Appointment
          </button>
